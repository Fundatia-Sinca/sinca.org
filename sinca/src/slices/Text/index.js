...
const Text = ({ slice }) => {
  ...
  <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
    <div class="mx-auto max-w-5xl">
      <h2 class="text-xl font-semibold text-brand-darker  sm:text-2xl"><PrismicRichText field={slice.primary.title} /></h2>
      <div class="my-8 xl:mb-16 xl:mt-12">
        <PrismicNextImage field={slice.primary.main_photo} className="w-full rounded-lg" />
           </div>
